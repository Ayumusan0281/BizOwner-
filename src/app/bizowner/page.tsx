        ...
        <div className="max-w-[900px] mx-auto px-6 relative z-10">
          ...
          <FadeSlide direction="up">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
              {[
                { name: "BizOwner", logo: "/lp/bizowner-logo.png", tag: "個人向け", desc: "アカウント運用×\u200b起業支援", active: true },
          ...
          <FadeSlide direction="up" className="-mx-2 md:mx-0">
            <div className="bg-white rounded-2xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.08)] border border-gray-100 overflow-x-auto">
              <table className="w-full min-w-[520px] text-[12px] md:text-[14px]">
                ...
                <tbody>
                  {[
                    { label: "初期費用", biz: "500,000円（月額0円）", other: "100〜500万円", self: "0円〜" },
        ...
        <div className="relative z-10 max-w-[700px] mx-auto px-6 text-center">
          <FadeSlide direction="up">
            <div className="relative w-20 h-20 md:w-24 md:h-24 mx-auto mb-4">
              <Image src="/lp/bizowner-logo.png" alt="BizOwner" fill sizes="96px" className="object-contain brightness-0 invert" />
            </div>
