        ...
        <div className="max-w-[1000px] mx-auto px-6 relative z-10">
          ...
          <StaggerChildren staggerMs={150} className="flex flex-col md:flex-row items-stretch gap-3 md:gap-2">
            {[
              ...
              <div key={item.title} className="flex-1 flex flex-col md:flex-row items-center gap-1 md:gap-2">
                ...
                {i < arr.length - 1 && (
                  <span className="shrink-0 text-lp-accent font-bold text-[22px] leading-none md:[line-height:inherit] rotate-90 md:rotate-0 my-1 md:my-0">→</span>
                )}
              </div>
            ))}
          </StaggerChildren>
        ...
        <div className="relative z-10 max-w-[700px] mx-auto px-6 text-center">
          <FadeSlide direction="up">
            <div className="relative w-20 h-20 md:w-24 md:h-24 mx-auto mb-4">
              <Image src="/lp/kanehoshi-logo.png" alt="KaneHoshi" fill sizes="96px" className="object-contain brightness-0 invert" />
            </div>
